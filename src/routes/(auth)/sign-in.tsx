            ...
            >
              <FieldGroup>
                ...
                {hasSocial && emailEnabled && (
                  <FieldSeparator className="*:data-[slot=field-separator-content]:bg-[#fffaf1] *:data-[slot=field-separator-content]:text-[#766b5b]">
                    {m['common.sign.or']()}
                  </FieldSeparator>
                )}
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              {passwordResetEnabled && (
                                <Link
                                  ...
                                  className={`text-sm ${musicRoomAuthLinkClass}`}
                                >
